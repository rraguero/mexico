    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading"><h3>
                    Listado de clientes
                    <a href="<?= base_url('clientes/adicionar') ?>" data-toggle="tooltip" data-original-title="Agregar cliente" class="pull-right" style="font-size: 16px;"><i class="fa fa-plus"></i> Agregar</a>
                </h3>
            </div>
                            ...
                            <?php foreach ($clientes as $i => $row): ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a class="" href="<?= base_url("clientes/editar/".$row->id)?>" data-toggle="tooltip" data-original-title="Editar" class="fa fa-hover">
                                        ...
                                        <a class="" href="<?= base_url("clientes/detalles/".$row->id) ?>" data-toggle="tooltip" data-original-title="Detalles" class="fa fa-hover" >
...
<script type="text/javascript">
    ...
    function eliminar() {
        document.location = "<?= base_url('clientes/eliminar') ?>" + "/" + id;
    }
</script>