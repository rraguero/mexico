    ...
    <div class="col-md-12">
        <div class="panel">
            ...
            <div class="panel-body">
                <form class="form-horizontal" action="<?= base_url('carta/adicionar') ?>" method="POST">
                    <div class="box-body">               
                        <?= my_input('id', 'Número', 'Número', TRUE) ?>                     
                        <div class="form-group">
                            <label class="col-sm-2 control-label">Fecha</label>
                            <div class="col-sm-10">
                                <input type="text" class="date form-control" name="fecha" required placeholder="AAAA-MM-DD">
                            </div>
                        </div>
                        ...
                        <?= my_input('referencia', 'No. referencia', 'No. referencia', TRUE) ?>       
